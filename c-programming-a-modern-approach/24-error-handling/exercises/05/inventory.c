 ...
 * into the database. Prints an error message and returns prematurely if the
 ...
 * otherwise, prompts the user to enter change in quantity on hand and updates
 * the database.
 */
void update(void) {
  int i, number, change;
